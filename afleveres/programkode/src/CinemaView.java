...
class CinemaView extends JComponent {
    ...
    CinemaView(int rows, int seats, String title, String time, java.util.Date date, int hall,
        ...
        //Icons
        vacantSeat = new ImageIcon(this.getClass().getResource("VacantSeat.png"));
        occupiedSeat = new ImageIcon(this.getClass().getResource("occupiedSeat.png"));
        selectedSeat = new ImageIcon(this.getClass().getResource("selectedSeat.png"));
